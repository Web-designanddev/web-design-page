    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        <Card
          ...
          description="We start with a discovery phase to understand your business and your goals. We'll work with you to develop a strategy that aligns with your business"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="We develop and deliver the project.We'll work with you to ensure that your project is delivered on time and on budget."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="We launch your project."
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        <span className="absolute p-4 inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
        <span className="inline-flex h-full w-full cursor-pointer items-center p-4 justify-center rounded-full bg-slate-950 px-5 py-2 text-bold text-2xl font-medium text-white backdrop-blur-3xl">
          {order}
        </span>
      </button>
    </div>
